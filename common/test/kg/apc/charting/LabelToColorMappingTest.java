...
public class LabelToColorMappingTest {
	...
	public void canDetectInvalidHtmlColor() {
		...
		assertNull("Should have received null, since 'foo' is not a standard html color",c);
	}	
	@Test
	public void canDetectValidHtmlColor() {
		LabelToColorMapping mapping = new LabelToColorMapping();
		Color c = mapping.parseStandardHtmlColor("Red");
		assertEquals("Should have received red, since 'foo' is not a standard html color",new Color(0xFF0000), c );
	}	
	@Test
	...
	public void canGetColorMappedFromColorName() {
		...
		assertEquals("The color for my CPU label was supposed to be red", expectedColor, actualColor);
	...
	public void canDetectNoMap() {
		...
		assertNull("A mapping was found for my label, even though zero mappings were added.", actualColor);
