    ...
    <div class="container">
        ...
        <div class="site-header">
            ...
            <div class="sponsorship pull-right">
                <a href="https://up9.com/?utm_source=jpgc&utm_medium=banner&utm_campaign=jpgc_sponsor"><img src="/img/site/up9.svg" height="68" alt="UP9"></a>
                            ...
                            {if $item1.selected}
                                <li role="presentation" class="active">
                                    <a href="{'../'|str_repeat:$upper_repeats}{$item1.$a.link}/"><i
                                                class="fa {$item1.$a.ico}"></i> {$item1.$a.title|default:$item1.$a.link}
                                    </a>
                                </li>
                            {else}
...
<footer>
    <div class="container">
        <span>&copy; 2009-{"Y"|date} <a href="https://www.linkedin.com/in/andreypohilko">Andrey Pokhilko</a> and <a
