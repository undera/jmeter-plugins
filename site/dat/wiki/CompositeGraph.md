...
<span class=''>[<i class='fa fa-download'></i> Download](/?search=jpgc-graphs-composite)</span>
...
[Download Example Test Plan](/editor/?utm_source=jpgc&utm_medium=openurl&utm_campaign=examples#/img/examples/CompositeGraphExample.jmx)
