...
<span class=''>[<i class='fa fa-download'></i> Download](/?search=jpgc-ffw)</span>

JMeter has very simpe test results writing capabilities 
with [Simple Data Writer](http://jakarta.apache.org/jmeter/usermanual/component_reference.html#Simple_Data_Writer) plugin.
...
may find [here](http://jakarta.apache.org/jmeter/usermanual/listeners.html#sample_variables) 
...
[Download Example Test Plan](/editor/?utm_source=jpgc&utm_medium=openurl&utm_campaign=examples#/img/examples/FlexibleFileWriterExample.jmx)

[Tutorials](/wiki/FFWTutorials/)
