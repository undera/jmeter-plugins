...
<span class=''>[<i class='fa fa-download'></i> Download](/?search=jpgc-fifo)</span>
...
[example test plan](/editor/?utm_source=jpgc&utm_medium=openurl&utm_campaign=examples#/img/examples/SynchronizationPluginsExample.jmx)
...
There is [example test plan](/editor/?utm_source=jpgc&utm_medium=openurl&utm_campaign=examples#/img/examples/SynchronizationExample.jmx) to see how it works.

fifoPut puts a value into queue and returns stored value. fifoPut parameters:
  1. Name of FIFO queue
  1. String to put into queue
...
fifoPop, fifoGet and fifoSize parameters:
  1. Name of FIFO queue
  1. Variable name to store value
...
You can learn inter-thread communication by reading the "[Async Download Tutorial](/wiki/AsyncDownloadTutorial/)".