...
Second, it will search for specified path, using syntax from [Jayway JsonPath 1.2.0](https://github.com/jayway/JsonPath). If the path is not found, it will fail.
