...
[Plugins Manager](/wiki/PluginsManager/) respects JMeter's [proxy settings](http://jmeter.apache.org/usermanual/get-started.html#proxy_server). However, to avoid editing the properties files, we recommend to launch JMeter with additional parameters to pass it the proxy settings:
