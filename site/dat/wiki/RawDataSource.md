...
<span class=''>[<i class='fa fa-download'></i> Download](/?search=jpgc-httpraw)</span>

This !PreProcessor allows more flexible file reading than
[CSV Data Set Config](http://jakarta.apache.org/jmeter/usermanual/component_reference.html#CSV_Data_Set_Config):
  - length-prefixed format allows storing and reading binary data, this is useful when you use TCP or Raw samplers
  - it is [PreProcessor](http://jakarta.apache.org/jmeter/usermanual/test_plan.html#preprocessors), so it may be placed in different scopes and affect selected samplers
...
[Download Example Test Plan](/editor/?utm_source=jpgc&utm_medium=openurl&utm_campaign=examples#/img/examples/RawDataSourceExample.jmx)

[Raw File Example #1 - HEX-encoded binary data for DNS requests](https://raw.github.com/undera/jmeter-plugins/master/extras/test/kg/apc/jmeter/modifiers/DNSJavaDecoderToRawData.out)

[Raw File Example #2 - Raw HTTP Requests](https://raw.github.com/undera/jmeter-plugins/master/extras/test/kg/apc/jmeter/modifiers/rawdata_crlf_metaline.txt)