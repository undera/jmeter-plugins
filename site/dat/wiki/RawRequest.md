...
JMeter's original [HTTP Request](http://jmeter.apache.org/usermanual/component_reference.html#HTTP_Request)
...
## Advantages of Raw Request
  ...
  - option to send file contents directly to network (lower memory usage on big files) ([Some details...](https://groups.google.com/forum/#!topic/jmeter-plugins/VDqXDNDCr6w/overview))
...
to read variable from file: [Raw Data Source](/wiki/RawDataSource/). Attaching this pre-processor
to your test plan gives you fast reading of any data into variable, which may be used in Raw Request.

## Example

[Download Test Plan](/editor/?utm_source=jpgc&utm_medium=openurl&utm_campaign=examples#/img/examples/RawRequestExample.jmx)

[Hidden Feature :&#41;](http://jmeter.512774.n5.nabble.com/fileupload-test-with-JMeter-td4267154.html) and [post on it](https://groups.google.com/forum/#!topic/jmeter-plugins/VDqXDNDCr6w)