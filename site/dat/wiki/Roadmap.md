...
==Web Driver Plugins==
  ...
  - Include more options in the GUI for configuring Web Driver instances as documented on the [Selenium website](https://code.google.com/p/selenium/wiki/DesiredCapabilities). (Issue 275)
  - Support collection of [W3C Navigation Timing](http://www.w3.org/TR/navigation-timing/) from supported browsers (Issue 277)
  - Support collection of [W3C Resource Timing](http://www.w3.org/TR/resource-timing/) from supported browsers (Issue 278)
  - Support collection of [W3C User Timing](http://www.w3.org/TR/user-timing/) from supported browsers   (Issue 279)
  - Graph data collected from W3C Timings (Issue 281)
  - Write data collected from W3C Timings in the [HAR file format](http://www.softwareishard.com/blog/har-12-spec/). (Issue 280)
  - Provide support for sampling Opera browser (Issue 282)
==Other==    
  - one more [AutoStop](/wiki/AutoStop/) criteria: when reached desired number of samples, duration criteria
