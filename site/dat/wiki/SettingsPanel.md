...
===Rendering Options===
Some of these options can be set globally using the user.properties file as described in the [installation procedure](/wiki/PluginInstall/).<br>
...
Notes:
- Colors can be specified using either the case-insensitive html color name or the the 6-hex-digit RGB value preceded by the pound/hash sign (#).  For details, [see here](http://www.w3schools.com/htmL/html_colornames.asp).  
