...
<span class=''>[<i class='fa fa-download'></i> Download](/?search=jpgc-udp)</span>

This plugin adds [UDP](http://en.wikipedia.org/wiki/User_Datagram_Protocol) protocol support to JMeter.
...
(like [TCP Sampler](http://jakarta.apache.org/jmeter/usermanual/component_reference.html#TCP_Sampler) do)
...
[Download Example Test Plan](/editor/?utm_source=jpgc&utm_medium=openurl&utm_campaign=examples#/img/examples/UDPRequestExample.jmx)

Article: [Performance Testing DNS Server with JMeter](/wiki/dns_test_using_jmeter/)