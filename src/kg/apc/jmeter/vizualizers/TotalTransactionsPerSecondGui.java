...
{
    private static String obsoleteMsg = "This chart is obsolete. Please replace it with the new \"Transactions per Seconds\", and select \"Aggregated display\" in the settings panel.";
