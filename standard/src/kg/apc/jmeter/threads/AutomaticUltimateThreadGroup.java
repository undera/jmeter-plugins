...
public class AutomaticUltimateThreadGroup extends AbstractSimpleThreadGroup implements Serializable, TestListener {
	...
	public static final String DATA_PROPERTY = "automaticultimatethreadgroupdata";
	private PropertyIterator scheduleIT;
	private int threadsToSchedule;
	private CollectionProperty currentRecord;

	public AutomaticUltimateThreadGroup() {
		super();
	}
