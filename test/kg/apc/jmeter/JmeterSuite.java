 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({VizualizersSuite.class, PerfmonSuite.class, DcerpcSuite.class, ConfigSuite.class, ThreadsSuite.class, ControlSuite.class, UtilsSuite.class, ChartingSuite.class, SamplersSuite.class})
