...
public class BinaryUtilsTest {
    ...
    /**
     * Test of twoBytesToLongVal method, of class BinaryUtils.
     */
    @Test
    public void testTwoBytesToLongVal() {
        System.out.println("twoBytesToLongVal");
        byte byte1 = (byte) 0xa7;
        byte byte2 = 0x4c;
        long expResult = 42828L;
        long result = BinaryUtils.twoBytesToLongVal(byte2, byte1);
        assertEquals(expResult, result);
    }
}
